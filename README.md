...
ReSave работает с **YouTube, TikTok, Instagram, X/Twitter, Facebook, Vimeo, Twitch, Reddit** и другими источниками, которые поддерживает `yt-dlp`. Доступность конкретного сайта зависит от его текущих ограничений; для закрытых публикаций могут потребоваться cookies.
...
Сделано для тех, кто хочет сохранить нужное медиа в пару нажатий.
