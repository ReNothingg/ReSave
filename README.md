...
Рассылка: пришлите пост → проверьте его точную копию → подтвердите отправку.
До отправки пост можно заменить, во время — остановить рассылку.
Отчёт отдельно показывает ошибки и сообщения без подтверждения Telegram.
